...
def sfillers_jsd_by_period(df, word_col='chi_amod', period_col='subfolder', min_count=0):
    """
...
def consecutive_jsd(temp_slot_df, period_col="subfolder", slot_col=str):
    """
    Compute the consecutive Jensen-Shannon Divergence (JSD) of a.
    ...
    prob = freq.div(freq.sum(axis=1), axis=0)
